...
-	Investigacion de los diferentes metodos de ordenación.
-	Consulta de libros de c, estructura de datos y algoritmia.
-	Consulta a otros proyectos de alumnos.

### Uso de la IA:
-	Evaluacion de la diferentes estructuras de datos.
-	Evaluacion de la diferentes algoritmos de ordenacion y explicaciones paso a paso para entender su funcionamiento.
-	Elaboracion de los diagramas de flujo para el readme.
-	Automatizacion de las descripciones de las funciones de cada fichero.
